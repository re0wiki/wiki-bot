...
ENTRIES: list[Entry] = [
    ...
    Entry(name="亨克尔", aliases=("海因格",), en="Heinkel Astrea"),
    ...
    Entry(name="奇力塔卡", aliases=("奇利塔卡",), en="Kiritaka Muse"),
    Entry(
        name="安妮罗洁",
        aliases=("安妮罗泽",),
        ja="アンネローゼ·ミロード",
    ...
    Entry(name="戴因", aliases=("岱因",), ja="ダイン", en="Dain", cat="角色"),
    Entry(
        name="特姆兹",
        aliases=("提姆兹",),
        main=False,
    ...
    Entry(name="普莉斯卡"),
    Entry(name="李凯尔特", aliases=("里肯鲁多",), en="Rickert Hoffman"),
    ...
    Entry(name="琉加", aliases=("榴卡",), ja="リュカ", en="Lucas", cat="角色"),
    ...
    Entry(name="盖因", aliases=("凯因",), ja="カイン", en="Cain", cat="角色"),
    Entry(
        name="碧翠丝",
        ja="ベアトリス",
        en="Beatrice",
    ...
    Entry(name="莱普", aliases=("莱夫",), en="Leip Barielle"),
    ...
    Entry(
        name="赫鲁贝尔", aliases=("哈利贝尔",), ja="ハリベル", en="Halibel", cat="角色"
    ),
    ...
    Entry(name="米杰尔达", aliases=("米杰耳怛",), en="Mizelda Shudrak"),
    Entry(name="修德拉格", aliases=("貅德拉格",)),
    Entry(name="塔里塔", aliases=("塔立塔",), en="Taritta Shudrak"),
    Entry(
        name="乌塔卡塔",
        ja="ウタカタ·シュドラク",
        en="Utakata Shudrak",
    ...
    Entry(name="高朗", aliases=("高兰",), en="Gaoran Peitiet"),
    Entry(name="梅琳达", en="Melinda"),
    Entry(name="亚历克", ja="アレク·ホーシン", en="Alec Hoshin", cat="角色"),
    Entry(name="尤尔娜", aliases=("夜鸣",), en="Yorna Mishigure"),
    Entry(name="米西格雷", aliases=("魅时雨",)),
    Entry(name="古斯塔夫", ja="グスタフ·モレロ", en="Gustav Morello", cat="角色"),
    Entry(name="乔拉", aliases=("裘拉",), en="Jorah Pendleton"),
    ...
    Entry(name="秀佐", aliases=("沙助",), en="Shasuke"),
    ...
    Entry(name="伊鲁鲁克斯", aliases=("依鲁鲁库斯",), pattern="伊鲁鲁?克斯"),
    Entry(
        name="塞尔菲苏", aliases=("萨菲斯",), ja="サーフィス", en="Safis", cat="角色"
    ),
    Entry(name="瓦尔格伦", aliases=("瓦尔葛兰",), en="Valgren"),
    Entry(
        name="托尔多",
        ja="トルタ·ウィズリー",
        en="Tholter Weasily",
    ...
    Entry(name="玛里乌里", aliases=("马李巫李",), en="Mariuli Shudrak"),
    Entry(
        name="马泽里安",
        aliases=("马杰朗",),
        ja="マゼラン·スーウェン",
    ...
    Entry(
        name="葛兰希尔黛", aliases=("格兰希尔特",), note="艾尔莎·葛兰希尔黛；同名酒品牌"
    ),
    Entry(
        name="奥多",
        aliases=("欧德",),
    ...
    Entry(name="避风加护", aliases=("避风的加护",), cat="术语"),
    Entry(name="死神加护", aliases=("死神的加护",), cat="术语"),
    Entry(name="剑圣加护", aliases=("剑圣的加护",), cat="术语"),
    Entry(name="言灵加护", aliases=("言灵的加护",), cat="术语"),
    Entry(name="地灵加护", aliases=("地灵的加护",), cat="术语"),
    Entry(name="传心加护", aliases=("传心的加护",), cat="术语"),
    Entry(name="诱精加护", aliases=("诱精的加护",), cat="术语"),
