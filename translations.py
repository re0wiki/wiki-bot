...
ENTRIES: list[Entry] = [
    ...
    Entry(name="卡什采尔平原", aliases=(V("卡斯图鲁平原", Source.FAN),)),
    Entry(
        name="卡罗尔",
        en="Carol Remendis",
    ...
    Entry(name="塞格蒙德", aliases=(V("塞格姆多", Source.OFFICIAL_HANT, Part.FAMILY),)),
    ...
    Entry(name="爱蜜"),
    Entry(name="艾黑亚湿地", aliases=(V("艾西亚湿地", Source.FAN),)),
    Entry(
    ...
    Entry(
        name="科尼亚斯", aliases=(V("柯尔尼亚斯", Source.OFFICIAL_HANT, Part.FAMILY),)
    ),
    ...
    Entry(
        name="科斯茨尔", en="Costuul", cat="术语", aliases=(V("克斯泽尔", Source.FAN),)
    ),
    Entry(name="福尔图娜", ja="フォルトナ", en="Fortuna", cat="角色"),
    Entry(name="汤普森"),
    Entry(name="苏文", aliases=(V("思文", Source.OFFICIAL_HANT, Part.FAMILY),)),
    ...
    Entry(name="弗兰德斯", en="Flanders", aliases=(V("芙兰达兹", Source.FAN),)),
    Entry(
        name="米杰尔达",
        aliases=(V("米杰耳怛", Source.OFFICIAL_HANT, Part.GIVEN),),
        en="Mizelda Shudrak",
    ),
    Entry(name="修德拉格", aliases=(V("貅德拉格", Source.OFFICIAL_HANT, Part.FAMILY),)),
    Entry(
        name="塔里塔",
    ...
    Entry(name="米西格雷", aliases=(V("魅时雨", Source.OFFICIAL_HANT, Part.FAMILY),)),
    ...
    Entry(name="加姆莱特", aliases=(V("格姆雷特", Source.FAN),)),
    ...
    Entry(name="琉璃泪", aliases=(V("流丽连", Source.FAN),)),
    Entry(
        name="围巾多娜", aliases=(V("多娜狐", Source.FAN), V("领子多娜", Source.FAN))
    ),
    Entry(
        name="奥托",
        main=False,
    ...
    Entry(name="米蒂安"),
    Entry(name="阿拉基亚", aliases=(V("亚拉基亚", Source.OFFICIAL_HANT, Part.GIVEN),)),
    Entry(
        name="奇夏·金",
        aliases=(V("奇夏·戈尔德", Source.FAN, Part.FULL),),
        note="官方意译 戈尔德→金（英 Chisha Gold）",
    ),
    Entry(name="贝亚子", aliases=(V("贝阿子", Source.FAN), V("碧翠子", Source.FAN))),
    Entry(
        name="爱蜜莉雅炭",
    ...
    Entry(name="缪斯", aliases=(V("谬丝", Source.FAN),), note="奇力塔卡·缪斯/缪斯商会"),
    Entry(name="施瓦兹", aliases=(V("舒瓦茨", Source.FAN),), note="乐师 夏美·施瓦茨"),
    Entry(
        name="艾力欧尔",
        en="Elior",
    ...
    Entry(name="卫兹礼", aliases=(V("威兹利", Source.FAN),), note="托尔多·卫兹礼"),
    Entry(
        name="葛兰希尔黛",
    ...
    Entry(name="蓝色雷光", aliases=(V("青色雷光", Source.FAN),), note="塞西鲁斯称号"),
    Entry(
        name="皮克塔特", aliases=(V("聘可塔特", Source.FAN),), note="水门都市邻近都市"
    ),
    Entry(name="避风加护", aliases=(V("避风的加护", Source.FAN),), cat="术语"),
    Entry(name="死神加护", aliases=(V("死神的加护", Source.FAN),), cat="术语"),
    Entry(name="剑圣加护", aliases=(V("剑圣的加护", Source.FAN),), cat="术语"),
    Entry(name="言灵加护", aliases=(V("言灵的加护", Source.FAN),), cat="术语"),
    Entry(name="地灵加护", aliases=(V("地灵的加护", Source.FAN),), cat="术语"),
    Entry(name="传心加护", aliases=(V("传心的加护", Source.FAN),), cat="术语"),
    Entry(name="诱精加护", aliases=(V("诱精的加护", Source.FAN),), cat="术语"),
    Entry(name="魔操加护", aliases=(V("魔操的加护", Source.FAN),), cat="术语"),
    Entry(
        name="共感觉",
    ...
    Entry(name="不死王的洗礼", aliases=(V("不死王的圣礼", Source.FAN),), cat="术语"),
    Entry(name="寒冰烙印艺术", aliases=(V("冰印艺术", Source.FAN),), cat="术语"),
    Entry(name="冰柱界线", aliases=(V("冰柱魔线", Source.FAN),), cat="术语"),
    ...
    Entry(name="最优秀纪行", aliases=(V("最优纪行", Source.FAN),), note="EX4 书名"),
    Entry(name="王选前日谈", aliases=(V("王选前日谭", Source.FAN),), note="EX4 目录"),
    Entry(
        name="卡尔斯腾公爵领的战斗少女",
        aliases=(V("卡尔斯腾公爵领地的战乙女", Source.FAN),),
        note="EX1 章名",
    ),
    Entry(name="王族诱拐事件", aliases=(V("王族诱拐案", Source.FAN),), note="vol16"),
    Entry(name="丽格蕾特", aliases=(V("利格雷特", Source.FAN),), note="汉娜·丽格蕾特"),
    Entry(
        name="汉赛尔和格莱特",
    ...
    Entry(name="魔女因子", aliases=(V("大罪因子", Source.FAN),), cat="术语"),
    Entry(
        name="克劳泽列",
    ...
    Entry(name="雷德纳斯", aliases=(V("雷多纳斯", Source.FAN),), note="雷德纳斯台地"),
    Entry(
        name="六条舌",
...
RECORD_ONLY: list[Entry] = [
    ...
    Entry(
        name="弗鲁夫",
        aliases=(V("忽尔芙", Source.OFFICIAL_HANT, Part.GIVEN),),
        ja="フルフー",
        en="Frufoo",
        cat="角色",
        record_only=True,
