...
ENTRIES: list[Entry] = [
    Entry(name="丝碧卡", en="Natsuki Spica", aliases=(V("丝琵卡"), V("斯皮卡"))),
    Entry(name="亨克尔", aliases=(V("海因格"),), en="Heinkel Astrea"),
    ...
    Entry(name="卡什采尔平原", aliases=(V("卡斯图鲁平原"),)),
    Entry(name="卡罗尔", en="Carol Remendis", aliases=(V("卡萝尔"), V("卡萝"))),
    Entry(name="卡米拉", ja="カーミラ", en="Carmilla", cat="角色"),
    Entry(name="古斯提克", en="Gusteko", cat="术语"),
    Entry(name="斯特莱德", en="Stride Vollachia", aliases=(V("史泰德"),)),
    Entry(name="塞西鲁斯", ja="セシルス·セグムント", en="Cecilus Segmunt", cat="角色"),
    Entry(name="塞格蒙德", aliases=(V("塞格姆多"),)),
    ...
    Entry(name="奇力塔卡", aliases=(V("奇利塔卡"),), en="Kiritaka Muse"),
    Entry(
        name="安妮罗洁",
        aliases=(V("安妮罗泽"),),
        ja="アンネローゼ·ミロード",
    ...
    Entry(
        name="弗里格尔",
        aliases=(V("弗琉盖尔"), V("富鲁盖尔")),
        ja="フリューゲル",
        en="Flugel",
        cat="角色",
    ),
    Entry(name="弗莱巴尔", en="Fribal van Astrea"),
    Entry(name="戴因", aliases=(V("岱因"),), ja="ダイン", en="Dain", cat="角色"),
    Entry(
        name="特姆兹",
        aliases=(V("提姆兹"),),
        main=False,
    ...
    Entry(name="普莉斯卡"),
    Entry(name="李凯尔特", aliases=(V("里肯鲁多"),), en="Rickert Hoffman"),
    ...
    Entry(name="梅娜", ja="メイーナ", en="Meina", cat="角色", aliases=(V("梅伊纳"),)),
    ...
    Entry(name="琉加", aliases=(V("榴卡"),), ja="リュカ", en="Lucas", cat="角色"),
    ...
    Entry(name="盖因", aliases=(V("凯因"),), ja="カイン", en="Cain", cat="角色"),
    Entry(
        name="碧翠丝",
        ja="ベアトリス",
        en="Beatrice",
        cat="角色",
        aliases=(V("贝阿托莉丝"), V("贝翠丝")),
    ),
    Entry(name="米塞尔", cat="角色", aliases=(V("米捷尔"),), note="米塞尔子爵"),
    ...
    Entry(name="爱蜜"),
    Entry(name="艾黑亚湿地", aliases=(V("艾西亚湿地"),)),
    Entry(
    ...
    Entry(name="莱普", aliases=(V("莱夫"),), en="Leip Barielle"),
    Entry(name="菜月菜穗子", en="Natsuki Naoko", aliases=(V("菜月·菜穗子"),)),
    Entry(name="菜月贤一", en="Natsuki Kenichi", cat="角色", aliases=(V("菜月·贤一"),)),
    ...
    Entry(
        ...
        en="Regulus Corneas",
        cat="角色",
        aliases=(V("雷古勒斯"), V("雷格勒斯")),
        note="字序调换（格鲁/古勒）p2o 覆盖不了，走精确对",
    ),
    Entry(name="科尼亚斯", aliases=(V("柯尔尼亚斯"),)),
    ...
    Entry(name="奥康奈尔", aliases=(V("欧克奈尔"),), note="弗洛普/米蒂安·奥康奈尔"),
    ...
    Entry(name="弗兰德斯", en="Flanders", aliases=(V("芙兰达兹"),)),
    Entry(name="米杰尔达", aliases=(V("米杰耳怛"),), en="Mizelda Shudrak"),
    Entry(name="修德拉格", aliases=(V("貅德拉格"),)),
    Entry(name="塔里塔", aliases=(V("塔立塔"),), en="Taritta Shudrak"),
    Entry(
        name="乌塔卡塔",
        ja="ウタカタ·シュドラク",
        en="Utakata Shudrak",
        cat="角色",
        aliases=(V("乌卡塔卡"), V("巫它卡它")),
    ),
    Entry(name="迪克尔", en="Zikr Osman"),
    Entry(name="高朗", aliases=(V("高兰"),), en="Gaoran Peitiet"),
    Entry(name="梅琳达", en="Melinda"),
    Entry(name="亚历克", ja="アレク·ホーシン", en="Alec Hoshin", cat="角色"),
    Entry(name="尤尔娜", aliases=(V("夜鸣"),), en="Yorna Mishigure"),
    Entry(name="米西格雷", aliases=(V("魅时雨"),)),
    Entry(name="古斯塔夫", ja="グスタフ·モレロ", en="Gustav Morello", cat="角色"),
    Entry(name="乔拉", aliases=(V("裘拉"),), en="Jorah Pendleton"),
    ...
    Entry(name="秀佐", aliases=(V("沙助"),), en="Shasuke"),
    ...
    Entry(name="加姆莱特", aliases=(V("格姆雷特"),)),
    ...
    Entry(
        name="丹克肯",
        pattern="丹克(尔)?肯",
        aliases=(V("邓克尔肯"), V("丹特肯")),
        note="奥尔巴特·丹克肯",
    ),
    Entry(name="卡夫马", en="Kafma Irulux"),
    Entry(name="伊鲁鲁克斯", aliases=(V("依鲁鲁库斯"),), pattern="伊鲁鲁?克斯"),
    Entry(
        name="塞尔菲苏", aliases=(V("萨菲斯"),), ja="サーフィス", en="Safis", cat="角色"
    ),
    Entry(name="瓦尔格伦", aliases=(V("瓦尔葛兰"),), en="Valgren"),
    Entry(
        name="托尔多",
        ja="トルタ·ウィズリー",
        en="Tholter Weasily",
    ...
    Entry(name="慕斯兰", aliases=(V("姆斯朗"), V("穆斯兰")), note="慕斯兰·卡拉德"),
    ...
    Entry(name="玛里乌里", aliases=(V("马李巫李"),), en="Mariuli Shudrak"),
    Entry(
        name="马泽里安",
        aliases=(V("马杰朗"),),
        ja="マゼラン·スーウェン",
    ...
    Entry(name="卡欧斯福莱姆", en="Chaosflame", cat="术语", aliases=(V("混沌之炎"),)),
    Entry(
        name="梅佐雷亚",
        ja="メゾレイア",
        en="Mezoreia",
    ...
    Entry(
        name="视风加护",
        aliases=(V("风见的加护"), V("视风的加护")),
        cat="术语",
        note="库珥修的加护",
    ),
    Entry(
        name="阿内芙",
        aliases=(V("阿尔内布"), V("亚尔聂博")),
        main=False,
    ...
    Entry(name="琉璃泪", aliases=(V("流丽连"),)),
    Entry(name="围巾多娜", aliases=(V("多娜狐"), V("领子多娜"))),
    Entry(
        name="奥托",
        main=False,
        aliases=(V("欧托"),),
    ...
    Entry(name="米蒂安"),
    Entry(name="阿拉基亚", aliases=(V("亚拉基亚"),)),
    Entry(
        name="奇夏·金",
        aliases=(V("奇夏·戈尔德"),),
        note="官方意译 戈尔德→金（英 Chisha Gold）",
    ),
    Entry(name="贝亚子", aliases=(V("贝阿子"), V("碧翠子"))),
    Entry(name="爱蜜莉雅炭", aliases=(V("爱蜜莉雅碳"),), note="帕克对爱蜜莉雅的昵称"),
    Entry(
        name="普利斯提拉",
        ja="プリステラ",
        en="Priestella",
    ...
    Entry(name="缪斯", aliases=(V("谬丝"),), note="奇力塔卡·缪斯/缪斯商会"),
    Entry(name="施瓦兹", aliases=(V("舒瓦茨"),), note="乐师 夏美·施瓦茨"),
    Entry(
        name="艾力欧尔",
        en="Elior",
        aliases=(V("艾利奥尔"), V("艾利欧尔")),
        note="艾力欧尔大森林",
    ),
    ...
    Entry(name="迷尼亚", aliases=(V("米尼亚"),), note="咒语后缀 X·迷尼亚（ミーニャ）"),
    Entry(
        name="米尔德",
        ja="ミルデ·アーラム",
        en="Milde Arlam",
    ...
    Entry(name="卫兹礼", aliases=(V("威兹利"),), note="托尔多·卫兹礼"),
    Entry(
        name="葛兰希尔黛",
        aliases=(V("格兰希尔特"),),
    ...
    Entry(name="马斯卡莱德", aliases=(V("玛斯柯瑞德"),), note="莉莉安娜·马斯卡莱德"),
    Entry(name="蓝色雷光", aliases=(V("青色雷光"),), note="塞西鲁斯称号"),
    Entry(name="皮克塔特", aliases=(V("聘可塔特"),), note="水门都市邻近都市"),
    Entry(name="避风加护", aliases=(V("避风的加护"),), cat="术语"),
    Entry(name="死神加护", aliases=(V("死神的加护"),), cat="术语"),
    Entry(name="剑圣加护", aliases=(V("剑圣的加护"),), cat="术语"),
    Entry(name="言灵加护", aliases=(V("言灵的加护"),), cat="术语"),
    Entry(name="地灵加护", aliases=(V("地灵的加护"),), cat="术语"),
    Entry(name="传心加护", aliases=(V("传心的加护"),), cat="术语"),
    Entry(name="诱精加护", aliases=(V("诱精的加护"),), cat="术语"),
    Entry(name="魔操加护", aliases=(V("魔操的加护"),), cat="术语"),
    Entry(name="共感觉", aliases=(V("共感的加护"),), cat="术语", note="官方从不称加护"),
    Entry(name="不死王的洗礼", aliases=(V("不死王的圣礼"),), cat="术语"),
    Entry(name="寒冰烙印艺术", aliases=(V("冰印艺术"),), cat="术语"),
    Entry(name="冰柱界线", aliases=(V("冰柱魔线"),), cat="术语"),
    Entry(name="爱蜜莉雅", ja="エミリア", en="Emilia", cat="角色"),
    Entry(name="普勒阿得斯", aliases=(V("普雷阿迪斯"),), note="普勒阿得斯监视塔"),
    Entry(
        name="三笨蛋出发！土蜘蛛篇",
        aliases=(V("三傻同行！土蜘蛛篇"),),
        note="vol16 译注引题",
    ),
    Entry(name="最优秀纪行", aliases=(V("最优纪行"),), note="EX4 书名"),
    Entry(name="王选前日谈", aliases=(V("王选前日谭"),), note="EX4 目录"),
    Entry(
        name="卡尔斯腾公爵领的战斗少女",
        aliases=(V("卡尔斯腾公爵领地的战乙女"),),
        note="EX1 章名",
    ),
    Entry(name="王族诱拐事件", aliases=(V("王族诱拐案"),), note="vol16"),
    Entry(name="丽格蕾特", aliases=(V("利格雷特"),), note="汉娜·丽格蕾特"),
    Entry(
        name="汉赛尔和格莱特",
        aliases=(V("汉赛尔与格莱特"),),
        note="vol26；格林童话《糖果屋》",
    ...
    Entry(name="魔女因子", aliases=(V("大罪因子"),), cat="术语"),
    Entry(name="克劳泽列", aliases=(V("克劳泽利亚"),), note="术式 阿尔·克劳泽列"),
    Entry(name="库拉利斯特", aliases=(V("克劳利斯塔"),), note="术式 阿尔·库拉利斯特"),
    Entry(name="雷德纳斯", aliases=(V("雷多纳斯"),), note="雷德纳斯台地"),
    Entry(name="六条舌", aliases=(V("六枚舌"),), note="奥尔菲外号及其情报组织"),
