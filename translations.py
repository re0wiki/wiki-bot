...
ENTRIES: list[Entry] = [
    ...
    Entry(
        ...
        en="Royal Guard",
        aliases=("王国近卫骑士团",),
        note="术语。官方：近卫骑士团 76 处、王国近卫骑士团 12 处（官方异写，按多裁决）",
    ),
    Entry(
        std="国王选举仪式",
