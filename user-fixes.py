...
translation_manual = [  # 手动添加的替换组（结构规则：模板替换/防误伤 lookaround/选择性展开）
    ...
    (r"(?<!格拉姆)(?<!芙兰)达[兹茲](?!利)", "达茨"),  # 达兹→达茨，guard 沿自记录（芙兰达兹 是 弗兰德斯 的别名）
    (r"(?<!加)(?<!卡)(?<!雷)德[纳納]", "多纳"),  # 德纳→多纳；加德纳/卡德纳/雷德纳斯 是他名
    (r"(?<!佩)(?<!芙蕾)多尔肯(?!罗登|普里恩)", "多尔凯尔"),  # 多尔肯→多尔凯尔，guard 沿自记录
...
_GUARDED_ALIASES = {"莉娅", "亚齐", "阿奇", "提娜", "弗利艾", "欧德", "达兹", "德纳", "多尔肯", "卡萝", "王选前日谭", "最优纪行", "王族诱拐案"}
